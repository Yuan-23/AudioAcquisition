                    ...
                    try {
                        switch (holder.sort) {
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                audioFile6 = File.createTempFile("record66_", ".wav");
                                mediaRecorder.setOutputFile(audioFile6.getAbsolutePath());
                                break;
                            case 7:
                                audioFile7 = File.createTempFile("record77_", ".wav");
                                mediaRecorder.setOutputFile(audioFile7.getAbsolutePath());
                                break;
                            case 8:
                                audioFile8 = File.createTempFile("record88_", ".wav");
                                mediaRecorder.setOutputFile(audioFile8.getAbsolutePath());
                                break;
                            case 9:
                                audioFile9 = File.createTempFile("record99_", ".wav");
