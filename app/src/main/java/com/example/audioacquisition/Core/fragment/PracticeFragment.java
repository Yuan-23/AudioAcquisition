...
import com.example.audioacquisition.Practice.activity.OtherActivity;
import com.example.audioacquisition.Practice.activity.PolicyActivity;
import com.example.audioacquisition.Practice.activity.TeachActivity;
import com.example.audioacquisition.Practice.activity.TestActivity;
import com.example.audioacquisition.Practice.activity.TypicalActivity;
...
public class PracticeFragment extends Fragment {
    ...
    private LinearLayout practice11;
    private LinearLayout practice12;
    private LinearLayout practice13;
    private LinearLayout practice21;
    private LinearLayout practice22;
    private LinearLayout practice23;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        practice11 = view.findViewById(R.id.practice_11);
        practice12 = view.findViewById(R.id.practice_12);
        practice13 = view.findViewById(R.id.practice_13);

        practice21 = view.findViewById(R.id.practice_21);
        practice22 = view.findViewById(R.id.practice_22);
        practice23 = view.findViewById(R.id.practice_23);


        practice11.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        practice12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        practice13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        practice21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        practice22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        practice23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        banner = view.findViewById(R.id.practice_banner);
        recyclerView = view.findViewById(R.id.first_rv);


        mswipeRefreshLayout = view.findViewById(R.id.first_swipe);
        // 设置下拉圆圈上的颜色，蓝色、绿色
