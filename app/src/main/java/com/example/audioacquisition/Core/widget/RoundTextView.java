package com.example.audioacquisition.Core.widget;
...
public class RoundTextView extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes != null) {
            ...
            int bgColor = attributes.getColor(R.styleable.RoundTextView_rtvBgColor, Color.YELLOW);
            attributes.recycle();
