...
import com.example.audioacquisition.Home.adapter.MoniAdapter;
import com.example.audioacquisition.Home.bean.DetailBean;
import com.example.audioacquisition.Home.passbean.DetailPassBean;
import com.example.audioacquisition.Home.passbean.ScoreBean;
                ...
                .execute(new GsonCallback<DetailPassBean>(DetailPassBean.class) {
                    ...
                    public void onSuccess(Response<DetailPassBean> response) {
                        ...
                        if (body.status.equals("200")) {
                            ...
                            MoniAdapter moniAdapter14 = new MoniAdapter(detailBeanList44, getActivity());
                            mstagerv4.setAdapter(moniAdapter14); //dialog.show
